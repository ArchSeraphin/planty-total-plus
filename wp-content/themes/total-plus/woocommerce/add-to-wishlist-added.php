...
<div class="yith-wcwl-wishlistaddedbrowse">
    ...
    <a href="<?php echo esc_url($wishlist_url); ?>" rel="nofollow" data-title="<?php echo esc_attr($browse_wishlist_text); ?>">
        <?php echo (!$is_single && ('before_image' === $loop_position || 'shortcode' === $loop_position) ) ? $icon : false; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped  ?>
        <span><?php echo wp_kses_post(apply_filters('yith-wcwl-browse-wishlist-label', $browse_wishlist_text, $product_id, $icon)); ?></span>
    </a>
</div>