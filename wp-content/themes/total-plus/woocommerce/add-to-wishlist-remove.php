...
<div class="yith-wcwl-add-button">
    ...
    <?php if ($show_view): ?>
        <span class="separator"><?php esc_html_e('or', 'total-plus'); ?></span>
        <a href="<?php echo esc_url($found_in_list->get_url()); ?>" class="view-wishlist"><?php echo esc_html(apply_filters('yith_wcwl_view_wishlist_label', __('View &rsaquo;', 'total-plus'))); ?></a>
    <?php endif; ?>
</div>
