 ...
 *
 */
function total_plus_header_style() {
    return 'horizontal';
}

define('TOTAL_PLUS_ELEMENTOR_ACTIVE', class_exists('Elementor\Plugin'));
define('TOTAL_PLUS_BEAVER_BUILDER_ACTIVE', class_exists('FLBuilder'));
define('TOTAL_PLUS_SITEORIGIN_ACTIVE', class_exists('SiteOrigin_Panels'));

if (!class_exists('Total_Plus_Custom_Nav_Walker')) {

    class Total_Plus_Custom_Nav_Walker extends Walker_Nav_Menu {
        ...
        public function start_lvl(&$output, $depth = 0, $args = array()) {
            ...
            if ($depth === 0 && $this->megamenu != '' && $this->megamenu != 'normal' && 'full_screen' != total_plus_header_style() && 'vertical' != total_plus_header_style()) {
        ...
        public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            // Mega menu
            if ($depth === 0 && $this->has_children && $item->category_post == '' && 'vertical' != total_plus_header_style()) {
            ...
            if ($depth === 0 && $item->category_post != '' && $item->object == 'category' && 'vertical' != total_plus_header_style()) {
            ...
            $item_output .= '</a>';
            if ($depth !== 0 && $item->megamenu_template && $this->megamenu != 'normal' && 'vertical' != total_plus_header_style()) {
                ob_start();
            ...
            if ($depth !== 0 && $item->megamenu_widgetarea && $this->megamenu != 'normal' && 'vertical' != total_plus_header_style()) {
                ob_start();
        ...
        public function end_el(&$output, $item, $depth = 0, $args = array()) {
            ...
            // Header style
            $header_style = total_plus_header_style();

            if ($depth === 0 && $item->category_post != '' && 'full_screen' != $header_style && 'vertical' != $header_style) {

                global $post;

                $output .= "\n<ul class=\"megamenu col-4 sub-menu ht-clearfix\">\n";
