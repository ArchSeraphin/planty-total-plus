...
$header_class = array('ht-site-header', 'ht-header-five', $total_plus_mh_menu_hover_style);
...
<header id="ht-masthead" class="<?php echo esc_attr(implode(' ', $header_class)); ?>">
    ...
    if ($total_plus_top_header == 'on') {
        ?>
        <div class="ht-top-header ht-container">
            <div class="ht-top-header-wrap ht-clearfix">
