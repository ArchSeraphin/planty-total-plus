 ...
 *
 */
class Total_Plus_Customizer_Importer {
    ...
    public static function import($customizerFile) {
        ...
        if ('array' != gettype($data)) {
            $error = __('Error importing settings! Please check that you uploaded a customizer export file.', 'total-plus');
            return;
        }
        ...
        if ($data['template'] != $template) {
            $error = __('Error importing settings! The settings you uploaded are not for the current theme.', 'total-plus');
            return;
        }
        ...
        if (isset($data['options'])) {
            ...
            foreach ($data['options'] as $option_key => $option_value) {
                $option = new Total_Plus_Customzer_Option($wp_customize, $option_key, array(
                    'default' => '',
                    'type' => 'option',
