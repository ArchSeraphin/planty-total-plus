...
class EDD_Theme_Updater_Admin {
    ...
    public function license_menu() {
        ...
        add_submenu_page('total-plus', $strings['theme-license'], $strings['theme-license'], 'manage_options', $this->theme_slug . '-license', array($this, 'license_page'));
    }
 ...
 */
function square_plus_theme_admin_notices() {
...
add_action('admin_notices', 'square_plus_theme_admin_notices');
