...
if (!class_exists('Total_Plus_TGM_Plugin')) {

    /**
     * Class Total_Plus_TGM_Plugin
     *
    ...
    class Total_Plus_TGM_Plugin {
         ...
         *
         *
         * @var Total_Plus_TGM_Plugin_Activation
         */
        protected $total_plus_tgmpa = null;

        /**
         * System status handler.
         *
         *
         * @var Total_PLus_System_Status
         */
         ...
         * @param total_plus_Demo_Pack $demo_pack   Demo pack to check against.
         *
         * @throws Exception
         */
        public function __construct($plugin_slug, $demo_pack = null) {
            // Initialize System Status.
            $this->system_status = Total_PLus_System_Status::obtain();
            ...
            if (empty($plugin_data)) {
                throw new Exception(esc_html__('Invalid plugin.', 'total-plus'));
            } elseif (!( isset($plugin_data['required']) && isset($plugin_data['recommended']) )) {
                throw new Exception(esc_html__('Invalid plugin data.', 'total-plus'));
            } elseif (!( $plugin_data['required'] || $plugin_data['recommended'] )) {
                throw new Exception(esc_html__('Non-TGM plugin.', 'total-plus'));
            }
        ...
        /**
         * Obtain a Total_Plus_TGM_Plugin object.
         *
         ...
         * @param total_plus_Demo_Pack $demo_pack   Demo pack to check against.
         *
         * @return WP_Error|Total_Plus_TGM_Plugin
         */
        ...
        protected function set_theme_required_version() {
            ...
            if (isset($this->total_plus_tgmpa->plugins[$this->get_slug()]['version'])) {
                $theme_required_version = $this->total_plus_tgmpa->plugins[$this->get_slug()]['version'];
            }
        ...
        protected function set_tags() {
            ...
            if (!empty($this->total_plus_tgmpa->plugins[$this->get_slug()]['tags'])) {
                $tgmpa_tags = array_unique(array_values($this->total_plus_tgmpa->plugins[$this->get_slug()]['tags']));
        ...
        public function get_actions_urls() {
            ...
            foreach ($actions_urls as $action => &$action_url) {
                ...
                $action_query_args = array(
                    'page' => urlencode($this->total_plus_tgmpa->menu),
                ...
                $action_url = esc_url(wp_nonce_url(
                                add_query_arg(
                                        $action_query_args, admin_url($this->total_plus_tgmpa->parent_slug)
        ...
        public function get_improved_tgmpa_data() {
            $tgmpa_data = $this->total_plus_tgmpa->plugins[$this->get_slug()];
