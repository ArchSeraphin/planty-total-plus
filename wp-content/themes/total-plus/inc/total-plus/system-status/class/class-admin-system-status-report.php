...
/**
 * Class Total_PLus_System_Status_Report
 *
...
class Total_PLus_System_Status_Report {
    ...
    public function __construct() {
         ...
         */
        $this->system_status = total_plus_admin_system_status();
    }

    /**
     * Obtain a Total_PLus_System_Status_Report object.
     *
     * The instance is saved to a static variable, so it can be retrieved
     * later without needing to be reinitialized.
     *
     *
     * @return Total_PLus_System_Status_Report
     */
    ...
    protected function get_theme_report() {
        $report = array(
            'slug' => $this->system_status->get_total_plus_slug(),
            'name' => $this->system_status->get_total_plus_name(),
            'version' => $this->system_status->get_total_plus_version(),
            'author' => array(
                'url' => $this->system_status->get_total_plus_author_url(),
            ),
            'url' => $this->system_status->get_total_plus_url(),
            'path' => $this->system_status->get_total_plus_path(),
            'child' => false,
        );
