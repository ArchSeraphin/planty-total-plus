...
/**
 * Class Total_PLus_System_Status
 *
...
class Total_PLus_System_Status {
    ...
    public function get_recommended_wp_version() {
        ...
        if (!$latest_version = get_transient('total_plus_system_status_recommended_wp_version')) {
            ...
            if (!is_wp_error($response) && isset($response['body'])) {
                ...
                set_transient('total_plus_system_status_recommended_wp_version', $latest_version, 60 * 60 * 12); // Updates every 12 hours.
            }
        }

        /**
         * @hook total_plus_system_status_recommended_wp_version
         *
         * Hook in here to modify the default recommended WP version.
         *
         */
        return apply_filters('total_plus_system_status_recommended_wp_version', $latest_version);
    }
    ...
    public function get_required_wp_version() {
        /**
         * @hook total_plus_system_status_required_wp_version
         *
         * Hook in here to modify the required WP version.
         *
         */
        return apply_filters('total_plus_system_status_required_wp_version', '4.4');
    }
    ...
    public function get_recommended_mysql_version() {
        return apply_filters('total_plus_system_status_recommended_mysql_version', '5.6');
    }
    ...
    public function get_required_mysql_version() {
        return apply_filters('total_plus_system_status_required_mysql_version', '5.0');
    }
    ...
    protected function set_plugins() {
        ...
        $tgmpa_required_plugins = Total_Plus_Recommended_Plugins::get_recommended_plugins();
        ...
        foreach ($tgmpa_required_plugins as $plugin_data) {
            ...
            $plugins[$plugin_path]['required'] = ( isset($plugin_data['required']) && total_plus_bool($plugin_data['required']) );
            $plugins[$plugin_path]['recommended'] = (!$plugins[$plugin_path]['required'] );
        }

        uasort($plugins, 'total_plus_uasort_plugins');
    ...
    public function get_recommended_php_version() {
        return apply_filters('total_plus_system_status_recommended_php_version', '5.6');
    }
    ...
    public function get_required_php_version() {
        return apply_filters('total_plus_system_status_required_php_version', '5.3');
    }
     ...
     * @return string
     */
    public function get_total_plus_name() {
        static $total_plus_name = null;

        if (is_null($total_plus_name)) {
            if ($this->is_child_theme()) {
                $total_plus_name = $this->get_parent_theme_name();
            } else {
                $total_plus_name = $this->get_theme_name();
            }
        }

        return $total_plus_name;
    }
     ...
     * @return string
     */
    public function get_total_plus_slug() {
        static $total_plus_slug = null;

        if (is_null($total_plus_slug)) {
            if ($this->is_child_theme()) {
                $total_plus_slug = $this->get_parent_theme_slug();
            } else {
                $total_plus_slug = $this->get_theme_slug();
            }
        }

        return $total_plus_slug;
    }
     ...
     * @return string
     */
    public function get_total_plus_url() {
        static $total_plus_url = null;

        if (is_null($total_plus_url)) {
            if ($this->is_child_theme()) {
                $total_plus_url = $this->get_parent_theme_url();
            } else {
                $total_plus_url = $this->get_theme_url();
            }
        }

        return $total_plus_url;
    }
     ...
     * @return string
     */
    public function get_total_plus_path() {
        static $total_plus_path = null;

        if (is_null($total_plus_path)) {
            if ($this->is_child_theme()) {
                $total_plus_path = $this->get_parent_theme_path();
            } else {
                $total_plus_path = $this->get_theme_path();
            }
        }

        return $total_plus_path;
    }
     ...
     * @return string
     */
    public function get_total_plus_version() {
        static $total_plus_version = null;

        if (is_null($total_plus_version)) {
            if ($this->is_child_theme()) {
                $total_plus_version = $this->get_parent_theme_version();
            } else {
                $total_plus_version = $this->get_theme_version();
            }
        }

        return $total_plus_version;
    }
     ...
     * @return string
     */
    public function get_total_plus_author_url() {
        static $total_plus_author_url = null;

        if (is_null($total_plus_author_url)) {
            if ($this->is_child_theme()) {
                $total_plus_author_url = $this->get_parent_theme_author_url();
            } else {
                $total_plus_author_url = $this->get_theme_author_url();
            }
        }

        return $total_plus_author_url;
    }
