...
function of_recognized_background_repeat() {
    $default = array(
        'no-repeat' => __('No Repeat', 'total-plus'),
        'repeat-x' => __('Repeat Horizontally', 'total-plus'),
        'repeat-y' => __('Repeat Vertically', 'total-plus'),
        'repeat' => __('Repeat All', 'total-plus'),
    );
...
function of_recognized_background_position() {
    $default = array(
        'top left' => __('Top Left', 'total-plus'),
        'top center' => __('Top Center', 'total-plus'),
        'top right' => __('Top Right', 'total-plus'),
        'center left' => __('Middle Left', 'total-plus'),
        'center center' => __('Middle Center', 'total-plus'),
        'center right' => __('Middle Right', 'total-plus'),
        'bottom left' => __('Bottom Left', 'total-plus'),
        'bottom center' => __('Bottom Center', 'total-plus'),
        'bottom right' => __('Bottom Right', 'total-plus')
    );
...
function of_recognized_background_attachment() {
    $default = array(
        'scroll' => __('Scroll Normally', 'total-plus'),
        'fixed' => __('Fixed in Place', 'total-plus')
    );
...
function of_recognized_font_styles() {
    $default = array(
        ...
        'italic' => __('Italic', 'total-plus'),
        'bold' => __('Bold', 'total-plus'),
        'bold italic' => __('Bold Italic', 'total-plus')
    );
