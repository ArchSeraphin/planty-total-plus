...
function icon_picker_field( $args, $echo = true ) {
	$defaults = array(
		...
		'select' => sprintf( '<a class="ipf-select">%s</a>', esc_html__( 'Select Icon', 'total-plus' ) ),
		'remove' => sprintf( '<a class="ipf-remove button hidden">%s</a>', esc_html__( 'Remove', 'total-plus' ) ),
	);
