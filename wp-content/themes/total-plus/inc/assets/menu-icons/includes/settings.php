...
final class Menu_Icons_Settings {
	...
	public static function _admin_notices() {
		$messages = array(
			'updated' => __( '<strong>Menu Icons Settings</strong> have been successfully updated.', 'total-plus' ),
			'reset'   => __( '<strong>Menu Icons Settings</strong> have been successfully reset.', 'total-plus' ),
		);
	...
	private static function _add_settings_meta_box() {
		add_meta_box(
			'menu-icons-settings',
			__( 'Menu Icons Settings', 'total-plus' ),
	...
	public static function get_settings_fields( array $values = array() ) {
		$fields = array(
			'hide_label' => array(
				'id'      => 'hide_label',
				'type'    => 'select',
				'label'   => __( 'Hide Label', 'total-plus' ),
				'default' => '',
				'choices' => array(
					array(
						'value' => '',
						'label' => __( 'No', 'total-plus' ),
					),
					array(
						'value' => '1',
						'label' => __( 'Yes', 'total-plus' ),
					),
				),
			),
			'position' => array(
				'id'      => 'position',
				'type'    => 'select',
				'label'   => __( 'Position', 'total-plus' ),
				'default' => 'before',
				'choices' => array(
					array(
						'value' => 'before',
						'label' => __( 'Before', 'total-plus' ),
					),
					array(
						'value' => 'after',
						'label' => __( 'After', 'total-plus' ),
					),
				),
			),
			'vertical_align' => array(
				'id'      => 'vertical_align',
				'type'    => 'select',
				'label'   => __( 'Vertical Align', 'total-plus' ),
				'default' => 'middle',
				'choices' => array(
					array(
						'value' => 'super',
						'label' => __( 'Super', 'total-plus' ),
					),
					array(
						'value' => 'top',
						'label' => __( 'Top', 'total-plus' ),
					),
					array(
						'value' => 'text-top',
						'label' => __( 'Text Top', 'total-plus' ),
					),
					array(
						'value' => 'middle',
						'label' => __( 'Middle', 'total-plus' ),
					),
					array(
						'value' => 'baseline',
						'label' => __( 'Baseline', 'total-plus' ),
					),
					array(
						'value' => 'text-bottom',
						'label' => __( 'Text Bottom', 'total-plus' ),
					),
					array(
						'value' => 'bottom',
						'label' => __( 'Bottom', 'total-plus' ),
					),
					array(
						'value' => 'sub',
						'label' => __( 'Sub', 'total-plus' ),
					),
				),
			),
			'font_size' => array(
	...
	public static function get_fields() {
		...
		$sections = array(
			'global' => array(
				'id'          => 'global',
				'title'       => __( 'Global', 'total-plus' ),
				'description' => __( 'Global settings', 'total-plus' ),
				'fields'      => array(
					array(
						'id'      => 'icon_types',
						'type'    => 'checkbox',
						'label'   => __( 'Icon Types', 'total-plus' ),
						'choices' => $icon_types,
		...
		if ( ! empty( $menu_id ) ) {
			...
			$sections['menu'] = array(
				'id'          => $menu_key,
				'title'       => __( 'Current Menu', 'total-plus' ),
				'description' => sprintf(
					__( '"%s" menu settings', 'total-plus' ),
				...
				<span class="list-controls">
					<?php
						printf(
							...
							esc_attr__( 'Discard all changes and reset to default state', 'total-plus' ),
							esc_html__( 'Reset', 'total-plus' )
						);
					?>
				</span>
	...
	public static function _enqueue_assets() {
		...
		$js_data = apply_filters(
			...
			array(
				'text'           => array(
					'title'        => __( 'Select Icon', 'total-plus' ),
					'select'       => __( 'Select', 'total-plus' ),
					'remove'       => __( 'Remove', 'total-plus' ),
					'change'       => __( 'Change', 'total-plus' ),
					'all'          => __( 'All', 'total-plus' ),
					'preview'      => __( 'Preview', 'total-plus' ),
					'settingsInfo' => '',
				),
