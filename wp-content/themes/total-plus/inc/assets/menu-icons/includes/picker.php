...
final class Menu_Icons_Picker {
		...
		?>
			<div class="field-icon description-wide menu-icons-wrap" data-id="<?php echo json_encode( $item->ID ); ?>">
				...
				<p class="description submitbox">
					<label><?php esc_html_e( 'Icon:', 'total-plus' ) ?></label>
					<?php printf( '<a class="_select">%s</a>', esc_html__( 'Select', 'total-plus' ) ); ?>
					<?php printf( '<a class="_remove submitdelete hidden">%s</a>', esc_html__( 'Remove', 'total-plus' ) ); ?>
				</p>
	...
	public static function _columns( $columns ) {
		$columns['icon'] = __( 'Icon', 'total-plus' );
