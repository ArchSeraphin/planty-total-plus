...
class RWMB_About {
	...
	public function plugin_links( $links ) {
		$links[] = '<a href="' . esc_url( $this->get_menu_link() ) . '">' . esc_html__( 'About', 'total-plus' ) . '</a>';
		return $links;
	}
	...
	public function add_submenu() {
		...
		$about       = add_submenu_page(
			$parent_menu,
			__( 'Welcome to Meta Box', 'total-plus' ),
			__( 'Dashboard', 'total-plus' ),
			'activate_plugins',
			'meta-box',
			array( $this, 'render' )
		);
	...
	public function change_footer_text() {
		...
		echo wp_kses_post( sprintf( __( 'Please rate <strong>Meta Box</strong> <a href="%1$s" target="_blank">&#9733;&#9733;&#9733;&#9733;&#9733;</a> on <a href="%1$s" target="_blank">WordPress.org</a> to help us spread the word. Thank you from the Meta Box team!', 'total-plus' ), 'https://wordpress.org/support/view/plugin-reviews/meta-box?filter=5#new-post' ) );
	}
