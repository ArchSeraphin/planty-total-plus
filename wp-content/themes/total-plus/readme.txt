...
* Menu Menu custom post type not displaying - Fixed

= 1.6.3 - Dec 18, 2024 =
* Elementor depreciated error issue - Fixed
* Stellar JS replaced with Custom JS code - Updated
* Other minor fixes

= 1.6.2 - Nov 14, 2024 =
* Elementor undefined variable error fixed in Slider Module
* Compatibility fixes with WordPress 6.7

= 1.6.1 - Nov 05, 2024 =
* Elementor undefined variable error fixed

= 1.6.0 - Mar 22, 2024 =
* Alpha Color Picker not working - Fixed
* Plugin not installed in Install Plugin page - Fixed

= 1.5.9 - Nov 06, 2023 =
* Add Media and Conditional logic on Metabox - Fixed

= 1.5.8 - Sep 05, 2023 =
* Walker warning issue fixed
* Fontawesome icon updated
* New Twitter icon updated
* EDD updater class updated

= 1.5.6 - May 05, 2023 =
* Menu Walker warning issue fixed
* Bug in Latest Post widget fixed
* Compatibility test with WordPress v6.2

= 1.5.5 - Apr 28, 2022 =
* Highlight block widget added
* Javascript fixes for Gutenberg Widgets
...
= 1.4.5 - May 23, 2020 =
* Megamenu issue in mobile device fixed
...
* Minor CSS fixed
* Metabox and it extension updated to latest version
...
= 1.3.3 - May 09, 2019 =
* Added option of colors in each sections
* Minor bug fixes in live customizer preview
...
* Option added to remove the space below the header and above the footer for each pages
